...
const EXPECTED_BUILD_ID = 'inkchapter-r58-7-evc3-canonical-transfer-empty-visual-rc3';
...
const OLD_BUILD_ID = 'inkchapter-r58-7-evc2-empty-equivalent-raf-fix-rc2';
const OLD_MAIN_SHA = '476CFD99548B471F8827E451E4692AB28AB9BD5D3FF12298390B379C1A15F124';
...
// IDENTITY-5: 旧 Build 不再作为 current expected value（用引号精确匹配，避免前缀误判）
assert.ok(!gateSrc.includes(`'${OLD_BUILD_ID}'`), 'IDENTITY-5 FAIL: old buildId still present');
